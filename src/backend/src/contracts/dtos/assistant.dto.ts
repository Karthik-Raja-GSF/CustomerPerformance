...
export interface ChatResponseDto {
  ...
  rawSql: string | null; // The SQL query generated by LLM (null if NO_QUERY_NEEDED)
  rawResult: unknown; // Raw database result before truncation (null if no query)
  sqlStatus: SqlStatus; // Execution status: success | empty | failed | not_needed
}
