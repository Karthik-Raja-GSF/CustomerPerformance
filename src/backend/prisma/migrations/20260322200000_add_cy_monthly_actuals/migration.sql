-- Update sync function to populate current year monthly breakdowns
-- The current_year_sales CTE is expanded with per-month CASE WHEN aggregations
-- (same pattern as last_year_sales CTE)
