-- Fix sync function: remove references to dropped ytd_usage column
-- The column was dropped in migration 20260323050344 but the function
-- was not updated, causing sync to fail at runtime.
