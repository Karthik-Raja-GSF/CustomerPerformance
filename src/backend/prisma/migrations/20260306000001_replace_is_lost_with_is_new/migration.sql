-- Replace is_lost with is_new:
-- - Rename column is_lost → is_new
-- - Rewrite sync function: remove Phase 2 (lost bids), add is_new detection
-- - Fix date filtering: use starting_date (not ending_date) for upper bound

-- ============================================================
-- Step 1: Rename column and update index
-- ============================================================
ALTER TABLE ait.customer_bid_data RENAME COLUMN is_lost TO is_new;

DROP INDEX IF EXISTS ait.customer_bid_data_is_lost_idx;
CREATE INDEX customer_bid_data_is_new_idx ON ait.customer_bid_data(is_new);

-- ============================================================
-- Step 2: Replace sync function
-- ============================================================
